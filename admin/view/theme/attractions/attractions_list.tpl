...
<div id="content"> 
  ...
  <div class="box">
  	<div class="heading">
      <h1><img src="view/image/product.png" alt="" /> 旅游景点</h1>
      <div class="buttons"><a href="<?php echo $insert; ?>" class="button">增加</a><a onclick="delete_action();" class="button">删除</a></div>
    </div>
	<div class="content">
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
      <textattraction id="sort_string" name="sort_string" style="display:none;"></textattraction>
        <table class="list">
          <thead>
            <tr>
            	<td width="1" style="text-align: center;"><input type="checkbox" onclick="$('input[name*=\'selected\']').attr('checked', this.checked);" /></td>
                <td class="center" >景点</td>
                <td class="center" style="width:60px;">精彩景点</td>
          ...
          <?php foreach ($attractions as $attraction) { ?>
            ...
            <td class="center"><?php echo $attraction['info']['wonderful']=='1'?'<i class="ui-icon ui-icon-star"></i>':'';?></td>
