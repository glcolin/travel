...
<div id="content"> 
  ...
  <div class="box">
  	<div class="heading">
      <h1><img src="view/image/product.png" alt="" /> 签证</h1>
        ...
        <table class="list">
          ...
          <?php foreach ($certificates as $certificate) { ?>
            ...
            <td style="text-align: center;">
                <input type="checkbox" name="selected[]" value="<?php echo $certificate['info']['id']; ?>" />
                <input type="hidden" name="pid" value="<?php echo $certificate['info']['id']; ?>" />
            </td>
            <td class="center"><img src="<?php echo $certificate['image']?>" style="padding: 1px; border: 1px solid #DDDDDD;"/></td>
            <td class="center"><?php echo $certificate['info']['title']?></td>
            <td class="center"><?php echo isset($categories[$certificate['info']['category']])?$categories[$certificate['info']['category']]:"";?></td>
            <td class="right"><?php foreach ($certificate['action'] as $action) { ?>
...
function save_sort(){
	...
	$.ajax({
		type: 'post',
		url : 'index.php?route=certificates/certificates/saveSort',
		dataType : "html",
		data: {
