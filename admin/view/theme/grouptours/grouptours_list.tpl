...
<div id="content"> 
  ...
  <div class="box">
  	<div class="heading">
      <h1><img src="view/image/product.png" alt="" /> 包团管理</h1>
	...
	<div class="content">
      ...
      <textgrouptour id="sort_string" name="sort_string" style="display:none;"></textgrouptour>
        <table class="list">
          <thead>
            <tr>
          ...
          <?php foreach ($grouptours as $grouptour) { ?>
            ...
            <!--<td style="text-align: center;">
                <input type="checkbox" name="selected[]" value="<?php echo $grouptour['info']['id']; ?>" />
                <input type="hidden" name="pid" value="<?php echo $grouptour['info']['id']; ?>" />
            </td>-->
            <td class="center"><?php echo $grouptour['number']?></td>
            <td class="center"><?php echo $grouptour['info']['name']?></td>
            <td class="center"><?php echo $grouptour['info']['phone']?></td>
            <td class="center"><?php echo $grouptour['create_date']?></td>
            <td class="right"><?php foreach ($grouptour['action'] as $action) { ?>
...
function save_sort(){
	...
	$.ajax({
		type: 'post',
		url : 'index.php?route=grouptours/grouptours/saveSort',
		dataType : "html",
		data: {
...
function filter() {
	url = 'index.php?route=grouptours/grouptours';
