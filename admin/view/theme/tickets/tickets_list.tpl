...
<div id="content"> 
  ...
  <div class="box">
  	<div class="heading">
      <h1><img src="view/image/product.png" alt="" /> 机票管理</h1>
	...
	<div class="content">
      ...
      <textticket id="sort_string" name="sort_string" style="display:none;"></textticket>
        <table class="list">
          <thead>
            <tr>
          ...
          <?php foreach ($tickets as $ticket) { ?>
            ...
            <!--<td style="text-align: center;">
                <input type="checkbox" name="selected[]" value="<?php echo $ticket['info']['id']; ?>" />
                <input type="hidden" name="pid" value="<?php echo $ticket['info']['id']; ?>" />
            </td>-->
            <td class="center"><?php echo $ticket['number']?></td>
            <td class="center"><?php echo $ticket['info']['name']?></td>
            <td class="center"><?php echo $ticket['info']['phone']?></td>
            <td class="center"><?php echo $ticket['create_date']?></td>
            <td class="right"><?php foreach ($ticket['action'] as $action) { ?>
...
function save_sort(){
	...
	$.ajax({
		type: 'post',
		url : 'index.php?route=tickets/tickets/saveSort',
		dataType : "html",
		data: {
...
function filter() {
	url = 'index.php?route=tickets/tickets';
