...
<script type="text/javascript">
	var accommodation_fee = JSON.decode('<?php echo $cruise['accommodation_fee'];?>');
	var line_id = '<?php echo $cruise['id'];?>';
	$(function() {
...
<?php echo $column_left;?>
	...
	<div class="f_r bb2 box mar_b_02  White1">
      <div class="beijing"><?php echo $cruise['title'];?></div>
...
<div class="f_r bb2 box mar_b_02  White1">
    ...
    <form action="./index.php?route=cruises/cruise/place_an_order" method="post" enctype="multipart/form-data">
      <input type="hidden" name="cruise_id" value="<?php echo $cruise['id'];?>" />
 ...
 <div>
	  ...
	  <div class="preview">
		<div class="scrolldoorFrame">
			...
			<div class="bor03 cont" style="min-height:350px;">
			<div id="c01">
				<?php echo htmlspecialchars_decode($cruise['content']);?>
			</div>
			<div id="c02">
				<?php echo htmlspecialchars_decode($cruise['otherfee']);?>
			</div>	
			<div id="c03" class="hidden">
                ...
                <form action="./index.php?route=cruises/cruise/add_comment" method="post" enctype="multipart/form-data">
                <input type="hidden" name="cruise_id" value="<?php echo $cruise['id'];?>" />
